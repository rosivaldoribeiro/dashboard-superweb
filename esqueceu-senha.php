...
<html class="loading" lang="pt" data-textdirection="ltr">
    <head>
        ...
        <title>Recuperar Senha | CyberProject</title>
  				...
  				<div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 register-card bg-opacity-8">
                    <form action="controller/recuperar-senha.php" class="login-form" method="post">
                        <div class="row">
                            ...
                            <h5 class="ml-4">Esqueceu a senha?</h5>
                            <p class="ml-4">Redefina sua senha agora.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                            <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12 mb-1">Recuperar</button>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <p class="margin medium-small"><a href="index.php">Acessar</a></p>
                            </div>
                            <div class="input-field col s6 m6 l6">
                            <p class="margin right-align medium-small"><a href="cadastro.php">Criar conta</a></p>
                            </div>
                        </div>
                    </form>
  				</div>
